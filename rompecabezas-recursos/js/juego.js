...
var instrucciones = [ "El cráter del volcán Quilotoa se ha desacomodado, ordena sus piezas guiándote de la imagen indicada aqui debajo.", "Utiliza las flechas del teclado para mover las diferentes piezas."];
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  var posAuxiliar = grilla[filaPos1][columnaPos1];
  grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
  grilla[filaPos2][columnaPos2] = posAuxiliar;
}  
